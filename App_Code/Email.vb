...
Public Class Email
    Public Shared Function SendEmail(ByVal FilePath As String, ByVal templateVars As Hashtable, ByVal Mailfrom As String, ByVal MailTo As String, ByVal Subject As String, ByVal BCC As String) As String
    ...
    Public Shared Function SendEMail(ByVal Mailfrom As String, ByVal MailTo As String, ByVal Subject As String, ByVal body As String, ByVal BCC As String) As String
        Try
            Dim mailadd As New System.Net.Mail.MailAddress(Mailfrom, "Website Enquiry Astrology Dunia")
